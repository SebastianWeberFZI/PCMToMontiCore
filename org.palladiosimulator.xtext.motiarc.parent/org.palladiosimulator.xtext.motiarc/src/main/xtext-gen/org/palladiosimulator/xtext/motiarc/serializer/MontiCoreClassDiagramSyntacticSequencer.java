...
public class MontiCoreClassDiagramSyntacticSequencer extends AbstractSyntacticSequencer {

	protected MontiCoreClassDiagramGrammarAccess grammarAccess;
	
	@Inject
	protected void init(IGrammarAccess access) {
		grammarAccess = (MontiCoreClassDiagramGrammarAccess) access;
	}
