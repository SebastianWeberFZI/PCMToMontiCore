...
public class MontiArcDSLSyntacticSequencer extends AbstractSyntacticSequencer {

	protected MontiArcDSLGrammarAccess grammarAccess;
	
	@Inject
	protected void init(IGrammarAccess access) {
		grammarAccess = (MontiArcDSLGrammarAccess) access;
	}
